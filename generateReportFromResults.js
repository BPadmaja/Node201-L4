...
readFile("results.json").then((data) => {
  if (data) {
    ...
    writeReport({
      ...
      status: "failure",
      feedback:
        "We are unable to test your submission - something about it was unsatisfied as per the given testcases, please check it. Please check the instructions for this task and try again. If you have seen this message more than once, please reach out to Pupilfirst team for support and help.",
